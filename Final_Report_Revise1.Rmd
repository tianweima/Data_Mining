...
`Sophie Song:` Average Vote Score Exploration, Movie Recommendation Modeling, Report  
`Xiaofang Jiang:` Data Wrangling, Report  
`Tianwei Ma:` Revenue Prediction Modeling, Report  
